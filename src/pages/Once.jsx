...
function Once() {
  ...
  const resolver = () => {
    ...
    if (confianza) {
      let rValues = [
        0.78, 0.98, 0.24, 0.73, 0.43, 0.16, 0.78, 0.47, 0.18, 0.55, 0.04, 0.29,
        0.68, 0.77, 0.16, 0.03, 0.79, 0.22, 0.37, 0.8, 0.96, 0.26, 0.91, 0.55,
        0.75, 0.55, 0.64, 0.39, 0.53, 0.45, 0.61, 0.14, 0.38, 0.12, 0.4, 0.74,
        0.78, 0.98, 0.27, 0.6, 0.43, 0.67, 0.62, 0.32, 0.53, 0.54, 0.24, 0.29,
        0.18, 0.08, 0.82, 0.94, 0.19, 0.98, 0.41, 1.0, 0.74, 0.92, 0.14, 0.43,
        0.83, 0.88, 0.18, 0.21, 0.5, 0.13, 0.43, 0.69, 0.08, 0.12, 0.22, 0.5,
        0.16, 0.11, 0.18, 0.89, 0.8, 0.42, 0.29, 0.87, 0.83, 0.79, 0.65, 0.28,
        0.78, 0.49, 0.36, 0.86, 0.87, 0.64, 0.51, 0.07, 0.18, 0.94, 0.5, 0.22,
        0.66, 0.91, 0.48, 0.24,
      ];
        ...
        {list.r.length > 0 && (
          <>
            ...
            <div className="w-full mt-6 flex flex-wrap min-h-lvh">
              <div className="w-1/3 p-10 h-full">
